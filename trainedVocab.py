...
sentence = input("Write any sentence which you would like to be editted: ")
word = input("Enter the word which you want to replace: ")
print_tuples(closest(get_word(str.lower(word))))
